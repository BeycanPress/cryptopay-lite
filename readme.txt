...
* https://sweetalert2.github.io/
    * Privacy policy: https://sweetalert2.github.io/
    * This is the main package to show alerts and modals.
...
= 2.3.16 =
* Updated: Default currency converter API

= 2.3.15 =
* Fixed: Text domain loading issue

= 2.3.14 =
* Fixed: WordPress.org commercial plugin requirements

= 2.3.11 =
* Updated: Fantom network to Base network
* Fixed: Exists user check on creating account during checkout

= 2.3.10 =
* Fixed: _load_textdomain_just_in_time early call

= 2.3.8 =
* Fixed: Ethereum Sepolia Testnet RPC not working
...
* Added TrustWallet, Binance Wallet support
...
= 1.1.1 =
* Changed "addon" param to "addon_lite" in cryptopay.js

= 1.1.0 =
* Changed "addOn" param to "addon"
